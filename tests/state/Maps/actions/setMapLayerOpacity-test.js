...
describe('state/Maps/actions/setMapLayerOpacity', function () {
	it('dispatch set layer opacity', function () {
		...
		dispatch(actions.setMapLayerOpacity('map1', 'layer1', 0.5));
	...
	it('dispatch error, mapXY does not exists', function () {
		...
		const dispatch = storeHelpers.getDispatch(getState, store.dispatch);
		dispatch(actions.setMapLayerOpacity('mapXY', 'layer1', 0.5));
	...
	it('dispatch error, layerXY does not exists in map1', function () {
		...
		const dispatch = storeHelpers.getDispatch(getState, store.dispatch);
		dispatch(actions.setMapLayerOpacity('map1', 'layerXY', 0.5));
